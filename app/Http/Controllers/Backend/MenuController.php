        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($menus)
                ...
                ->addColumn('action', function ($menu) {
                    ...
                    $btn .= '<a href="' . url("admin/menus/destroy/$menu->menu_id/$menu->id") . '" class="btn btn-danger" data-method="DELETE" data-token="' . csrf_token() . '" data-toggle="tooltip" title="Delete" data-confirm="Are you sure?"><i class="fas fa-trash-alt"></i></a>';
                    $btn .= "</div>";
                    return $btn;
                })
