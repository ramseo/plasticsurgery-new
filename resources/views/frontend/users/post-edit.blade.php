    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-9 user-posts">
                ...
                {{ html()->modelForm($module_name_singular, 'PATCH', route("frontend.profile_posts.update", $module_name_singular))->class('form')->open() }}
                        ...
                        <div class="form-group tags-group">
                            ...
                            <?php } else { ?>
                                ...
                                <select name="<?= $field_name ?>" class="form-control select2-related-posts" multiple>
                                    <?php
                                    $array_column = array_column($getSelectedPostVal, 'id');
                                    // dd($array_column);

                                    foreach ($getRelatedlPostsArr as $key => $item) {
                                        if ($key == $module_name_singular->id) {
                                            continue;
                                        }

                                        $select = "";
                                        if (in_array($key, $array_column)) {
                                            $select = "selected";
                                        }
                                    ?>
