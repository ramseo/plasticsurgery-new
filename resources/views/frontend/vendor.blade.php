        ...
        <div class="row">
            <div class="banner-container">
                <div class="vendor-img">
                    <img src="images/vendor-banner-min.jpg" alt="image alt" class="img-fluid">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xs-12 col-sm-12 footer-col">
                ...
                <ul class="list-inline">
                    <li class="list-inline-item"><a href=""><img src="images/i-btn.png" alt="" class="img-fluid"></a></li>
                    <li class="list-inline-item"><a href=""><img src="images/f-btn.png" alt="" class="img-fluid"></a></li>
                    <li class="list-inline-item"><a href=""><img src="images/p-btn.png" alt="" class="img-fluid"></a></li>
                </ul>
            </div>
            <div class="col-xs-12 col-sm-12 footer-col">
