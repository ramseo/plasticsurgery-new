                    ...
                    <select class="form-control" name="" id="">
                        ...
                        @if(isset($categories) && $categories)
                            @foreach($categories as $category)
                                <option value="{{$category->slug}}" {{$selected_type->slug == $category->slug ? 'selected' : ''}}>{{$category->name}}</option>
                            @endforeach
                        @endif
                    </select>
                </li>
                    ...
                    <select class="form-control" name="" id="">
                        ...
                        @if(isset($cities) && $cities)
                            @foreach($cities as $filter_city)
                                <option value="{{$filter_city->slug}}" {{$selected_city->slug == $filter_city->slug ? 'selected' : ''}}>{{$filter_city->name}}</option>
                            @endforeach
                        @endif
                    </select>
                </li>
                                    ...
                                    @foreach($services as $service)
                                        <li>
                                            <label class="custom-box-label">
                                                <input type="checkbox" class="" name="service" value="{{$service->name}}">
