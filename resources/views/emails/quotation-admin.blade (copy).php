                            ...
                            <td class="body" width="100%" cellpadding="0" cellspacing="0">
                                <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                                    ...
                                    <tr>
                                            ...
                                            <p>Quotation Request for vendor <a href="{{$details->vendor_data['vendor_url']}}" title="{{$details->vendor_data['vendor_business_name']}}">{{$details->vendor_data['vendor_business_name']}}</a></p> 
                                        </td>
                                    </tr>
                                </table>
                                <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
