                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <div class="float-right">
                            <a href="{{route('backend.travel.trashed', $travel)}}" class="btn btn-danger" data-method="DELETE" data-token="{{csrf_token()}}" data-toggle="tooltip" title="{{__('labels.backend.delete')}}"><i class="fas fa-trash-alt"></i></a>
