...
<x-backend-breadcrumbs>
    <x-backend-breadcrumb-item route='{{route("backend.customer.index")}}' icon='c-icon cil-people' >
        Customer
    </x-backend-breadcrumb-item>

    <x-backend-breadcrumb-item type="active">Customer</x-backend-breadcrumb-item>
</x-backend-breadcrumbs>
@endsection
...
{{--                                @endif--}}
{{--                                @if ($user->status == 2)--}}
{{--                                <a href="{{route('backend.users.unblock', $user)}}" class="btn btn-info" data-method="PATCH" data-token="{{csrf_token()}}" data-toggle="tooltip" title="{{__('labels.backend.unblock')}}" data-confirm="Are you sure?"><i class="fas fa-check"></i> Unblock</a>--}}
{{--                                @endif--}}
                                @if ($user->email_verified_at == null)
                                ...
                                @endif
{{--                                @if($user->id != 1)--}}
{{--                                <a href="{{route("backend.customer.destroy", $user)}}" class="btn btn-danger" data-method="DELETE" data-token="{{csrf_token()}}" data-toggle="tooltip" title="{{__('labels.backend.delete')}}" data-confirm="Are you sure?"><i class="fas fa-trash-alt"></i> Delete</a>--}}
{{--                                @endif--}}
                                <a href="{{ route("backend.customer.index") }}" class="btn btn-warning" data-toggle="tooltip" title="{{__('labels.backend.cancel')}}"><i class="fas fa-reply"></i> Cancel</a>
                            </div>
                        </div>
                    </div>
                {{ html()->closeModelForm() }}
