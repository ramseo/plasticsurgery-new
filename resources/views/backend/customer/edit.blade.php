...
{{--                                @endif--}}
                                ...
                                @endif
{{--                                @if($user->id != 1)--}}
{{--                                <a href="{{route("backend.customer.destroy", $user)}}" class="btn btn-danger" data-method="DELETE" data-token="{{csrf_token()}}" data-toggle="tooltip" title="{{__('labels.backend.delete')}}"><i class="fas fa-trash-alt"></i> Delete</a>--}}
{{--                                @endif--}}
