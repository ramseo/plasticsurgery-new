        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="float-right">
                    ...
                    <a href="{{route("backend.$module_name.deleteAll")}}" class="btn btn-danger mt-1" data-method="DELETE" data-token="{{csrf_token()}}" data-toggle="tooltip" title="@lang('Delete All Notifications')" data-confirm="Are you sure?"><i class="fas fa-trash-alt"></i></a>
                </div>
            </div>
        </div>
        <!--/.row-->
