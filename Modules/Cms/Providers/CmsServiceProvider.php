...
class CmsServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $kernel->pushMiddleware('Modules\Cms\Http\Middleware\GenerateMenus');

        // register commands
        $this->registerCommands('\Modules\Cms\Console');
    }
    ...
    {
        $this->publishes([
            module_path('Cms', 'Config/config.php') => config_path('article.php'),
        ], 'config');
        $this->mergeConfigFrom(
            module_path('Cms', 'Config/config.php'),
            'article'
        );
    }
